...
public class ParallelPathfindingEngine {
    ...
    public List<Path> processRequestsWithVisualization(List<PathRequest> requests,
    ...
    private Path findPathWithVisualization(PathRequest request, int pathIndex,
                                           VisualizationCallback callback) throws InterruptedException {
